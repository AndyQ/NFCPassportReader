...
public class PACEHandler {
    ...
    public func doPACE( paceKeySeed : String, paceKeyReference: UInt8) async throws {
        ...
        default:
            handleError( "PACE", "PACE Key Reference not supported (\(paceKeyReference)). Currently only 0x01 (MRZ) and 0x02 (CAN) may be used." )
            throw PACEHandlerError.keyReferenceNotSupported("PACE Key Reference not supported (\(paceKeyReference)). Currently only 0x01 (MRZ) and 0x02 (CAN) may be used.")
        }
