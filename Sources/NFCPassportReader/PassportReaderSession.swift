//
//  PassportReaderSession.swift
//  
//
//  Created by Andrej Rolih on 22/06/2022.
//
...
public class PassportReaderSession : NSObject {
    ...
    public func beginCommunicationSession(accessKey : String, paceKeyReference: UInt8, tags: [DataGroupId] = [], skipSecureElements : Bool = true, skipCA : Bool = false, skipPACE : Bool = false, customDisplayMessage : ((NFCViewDisplayMessage) -> String?)? = nil) async throws -> PassportCommunicationSession {
...
@available(iOS 13, *)
extension PassportReaderSession : NFCTagReaderSessionDelegate {
...
@available(iOS 13, *)
extension PassportReaderSession {
    
    func startReading(tagReader : TagReader) async throws -> PassportCommunicationSession {
        if !skipPACE {
            do {
